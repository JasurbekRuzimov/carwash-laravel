                    ...
                    <form action="{{ route('site.storeOrder', $moyka->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input required
                                   ...
                                   id="from" type="datetime-local" name="from">
                        </div>
                        <div class="mb-4">
                            ...
                            <input required
                                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                   id="to" type="datetime-local" name="to">
                        </div>
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('site.showNavbat', $moyka->id) }}"
                               class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Orqaga</a>
                        </div>

                        <input type="hidden" value="{{$moyka->id}}" name="moyka_id">
                    </form>
